    ...
    $(document).ready(function() {
        $("#grid").kendoGrid({
                ...
                transport: {
                    ...
                    parameterMap: function(options, operation) {
                        if (operation != "read") {
                            ...
                            options.date_donation = kendo.toString(new Date(d), "yyyy-MM-dd");
                            return options;
                        }
                        else {
                            return options;
                ...
                schema: {
                    ...
                    model: {
                        ...
                        fields: {
                            ...
                            date_donation: {type: "date", nullable: true,defaultValue:null },
            ...
            columns: [
                ...
                {field: "date_donation", title: "date de donnation", format: '{0:yyyy-MM-dd}', width: "100px", },
                ...
                {command: [{name: "edit", text: {edit: "Modif", cancel: "Annuler", update: "Valider"}},
                        {name: "destroy", text: "Suppr"}], title: "&nbsp;", width: "170px"}
            ],
            groupable: {
                messages: {
