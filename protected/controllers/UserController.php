    ...
    public function accessRules() {
        return array(
            array('allow', // allow admin user to perform 'admin' and 'delete' actions
                ...
                'users' => User::model()->getAdministratorsUsernamesList(),
            ),
...
// Uncomment the following line if AJAX validation is needed
        ...
        if (isset($_POST['User'])) {
            // Yii::app()->user->name = 'hghg';
            $model->username = $_POST['User']['username'];
            $model->password = crypt($_POST['User']['password']);
            $model->firt_name = $_POST['User']['firt_name'];
            $model->last_name = $_POST['User']['last_name'];
            $model->email = $_POST['User']['email'];
            $model->isActivated = $_POST['User']['isActivated'];
            if (Yii::app()->user->name === 'root')
                $model->isAdministrator = $_POST['User']['isAdministrator'];
            if ($model->save())
